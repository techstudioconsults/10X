  ...
  return (
    ...
    <hr className="bg-grey h-[2px] my-3"/>
      ...
      <div className='flex lg:flex-row flex-col items-start gap-6'>
          ...
          <form>
            ...
            <div className='flex md:flex-row flex-col my-6 gap-3 w-full'>
              <div className='flex flex-col xl:w-1/2 w-full gap-1'>
                ...
                <input type="text" placeholder='First Name' className=' w-full px-4 text-[#6476BA] h-12 rounded-md border-2 border-[#0000001A]  bg-transparent ' />
              </div>
              <div className='flex flex-col xl:w-1/2 w-full gap-1'>
                <label className='text-[#0027BA] font-medium'>Last Name</label>
                <input type="text" placeholder='Last Name' className='w-full text-[#6476BA]  px-4 h-12 rounded-md border-2 border-[#0000001A]  bg-transparent ' />
              </div>
            </div>
            <div  className='flex flex-col mb-6 gap-1'>
                <label className='text-[#0027BA] font-medium'>Email</label>
                <input type="email" placeholder='Email Address' className=' h-12 px-4 text-[#6476BA] rounded-md border-2 border-[#0000001A]  bg-transparent ' />
              </div>
        ...
        <div className=' lg:max-w-[401px] lg:w-1/2 w-full p-4 border-[#0000001A] border-2 shadow-md rounded-xl'>
